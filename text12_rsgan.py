...
# from models.slim.datasets import flowers
# from tensorflow.models.slim.datasets import flowers
...
height = width = 256
batch_size = 4
DATA_DIR="D:\python\demo1\TensorFlow_rumen\data_flowers"

#选择数据集validation
dataset = datasets.flowers.get_split('validation', DATA_DIR)
#创建一个provider
