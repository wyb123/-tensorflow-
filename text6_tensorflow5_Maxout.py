...
#参数设置
# learning_rate = 0.04
# exponential_decay指数式衰减
# 初始学习率
init_learning_rate = 0.1
global_step = tf.Variable(0, trainable=False)
learning_rate = tf.train.exponential_decay(init_learning_rate, global_step, decay_steps =10 , decay_rate=0.96,
